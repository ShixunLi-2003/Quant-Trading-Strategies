...
![Return vs Drawdown](./Parameter%20Sweep/return_vs_drawdown.png)

## Contents

- `Parameter Sweep`: translated summary table built from the original parameter-scan outputs, together with static robustness visuals.
